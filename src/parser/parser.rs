...
//                 self.ast.data_declarations.push(data);
...
//                 self.ast.data_declarations.push(class);
//             } else if token == Token::Keyword("instance") {
//                 instance = self.handle_instance()?;
//                 self.ast.instance_declarations.push(instance);
//             } else if token == Token::Variable(var) {
